...
class BlogPost(db.Model):
    ...
    comments = relationship("Comment", back_populates="blogpost_comment")
class Comment(db.Model):
    ...
    blogpost_comment = relationship("BlogPost", back_populates="comments")
...
def register():
    ...
    if request.method == "POST":
        ...
        new_password = generate_password_hash(original_password)
        new_user = User(
